...
res <- MCMC( p=log_posterior, n=1e5, init=start, scale=c(0.001,0.1,0.1,0.1), adapt=TRUE, acc.rate=0.234, fun=cholera_sirw, data=inc_obs, tstop=200, pyo=1e5, maxsteps=500, hmin=0.1, hmax=4 )
