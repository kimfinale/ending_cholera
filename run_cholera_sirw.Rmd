...
tic <- Sys.time()
res <- MCMC( p=log_posterior, n=1e2, init=start, scale=c(0.01,0.1,0.1,0.1), adapt=TRUE, acc.rate=0.234, fun=cholera_sirw, data=inc_obs, tstop=200, pyo=1e5 )
...
saveRDS( res, paste0( "out/res_", tstamp, ".rds") )
